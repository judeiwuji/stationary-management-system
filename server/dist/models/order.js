...
__decorate([
    (0, sequelize_typescript_1.Column)({ defaultValue: "pending", type: sequelize_typescript_1.DataType.STRING(20) }),
...
__decorate([
    ...
    sequelize_typescript_1.Column,
    __metadata("design:type", Number)
], Order.prototype, "requisitionId", void 0);
__decorate([
    (0, sequelize_typescript_1.BelongsTo)(() => requisition_1.default),
    __metadata("design:type", requisition_1.default)
], Order.prototype, "requisition", void 0);
__decorate([
    (0, sequelize_typescript_1.HasMany)(() => order_item_1.default),
