...
exports.ResetPasswordSchema = exports.IdentifyUserSchema = exports.UserUpdateSchema = exports.UserCreationSchema = void 0;
...
exports.IdentifyUserSchema = (0, yup_1.object)({
    email: (0, yup_1.string)().email('must be a valid email').required(),
});
exports.ResetPasswordSchema = (0, yup_1.object)({
    newPassword: (0, yup_1.string)().required(),
});
